...
<div class="control-group">
  <label class="control-label" for="serviceEpos">Номер услуги в EPOS</label>
  {include file="common/tooltip.tpl" tooltip="Можно узнать в личном кабинете сервиса \"Экспресс Платежи\" в настройках услуги."}
  <div class="controls">
    <input type="text" name="payment_data[processor_params][serviceEpos]" id="serviceEpos" value="{$processor_params.serviceEpos}" class="input-text" />
  </div>
</div>
...
{assign var="r_url" value="payment_notification.notify?payment=expresspayepos"|fn_url:'C':'https'}
<div class="control-group">
